        ...
        <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-between items-center text-sm pt-2">
                    ...
                    <button type="button" onClick={switchToForgot} className="font-medium text-[#14F195] hover:underline">Forgot password?</button>
                </div>
            ...
            <p className="text-sm text-center text-gray-500">
                Don't have an account? <button type="button" onClick={switchToSignup} className="font-medium text-[#14F195] hover:underline">Join Now</button>
            </p>
        </div>
    );
};
...
const SignUpForm = ({ onSignup, switchToSignin }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-sm text-center text-gray-500">
                Already have an account? <button type="button" onClick={switchToSignin} className="font-medium text-[#14F195] hover:underline">Sign In</button>
            </p>
        </div>
    )
}
...
const ForgotPasswordForm = ({ onForgot, switchToSignin }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-sm text-center text-gray-500">
                Remember your password? <button type="button" onClick={switchToSignin} className="font-medium text-[#14F195] hover:underline">Sign In</button>
            </p>
        </div>
    );
};
